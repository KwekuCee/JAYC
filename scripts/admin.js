...
async function loadActiveInviters() {
    try {
        ...
        const content = document.getElementById('activeInvitersContent');
        
        // Update overview stats
        document.getElementById('dailyActiveInviters').textContent = activeData.stats.total_daily;
        document.getElementById('weeklyActiveInviters').textContent = activeData.stats.total_weekly;
...
async function loadAdminData() {
    try {
        ...
        loadActiveInviters(); // Add this line
